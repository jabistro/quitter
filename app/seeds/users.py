...
def seed_users():
    ...
    david = User(
        ...
        password='password',
        header='https://pbs.twimg.com/profile_banners/20014300/1632467117/1500x500',
    ...
    christina = User(
        ...
        profile_pic='',
        display_name='Bobbie Bogay',
        bio='https://pbs.twimg.com/profile_images/1346983859716558849/os245gC1_400x400.jpg',
