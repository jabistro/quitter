...
class SignUpForm(FlaskForm):
    ...
    username = StringField('Username', validators=[DataRequired("Username must be between 1 and 15 characters"), Length(min=1, max=15, message="Username must be between 1 and 15 characters"), username_exists])
